...
for M in M_values:
    ...
    for l in range(L):
        ...
        for i in range(M):
            ...
            network.load_state_dict(torch.load("./root/evaluating_bdl/toyClassification/training_logs/model_Ensemble-MAP-SGDMOM_1_M1024_%d/checkpoints/model_Ensemble-MAP-SGDMOM_1_M1024_epoch_150.pth" % (l*M + i)))
