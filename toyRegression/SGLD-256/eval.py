...
for i in range(M):
    ...
    network = ToyNet("eval_SGLD-256_1", project_dir="./root/evaluating_bdl/toyRegression").cuda()
    network.load_state_dict(torch.load("./root/evaluating_bdl/toyRegression/training_logs/model_SGLD-256_1/checkpoints/model_SGLD-256_1_epoch_%d.pth" % int(num_epochs - i*step_size)))
