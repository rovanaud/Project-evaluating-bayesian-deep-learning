...
for M in M_values:
    ...
    for j in range(6):
        ...
        for i in range(M):
            ...
            network.load_state_dict(torch.load("./root/evaluating_bdl/toyRegression/training_logs/model_SGHMC-256_%d/checkpoints/model_SGHMC-256_%d_epoch_%d.pth" % (j+1, j+1, int(num_epochs - i*step_size))))
