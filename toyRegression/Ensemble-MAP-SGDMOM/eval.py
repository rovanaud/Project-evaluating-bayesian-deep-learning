...
for i in range(M):
    ...
    network.load_state_dict(torch.load("./root/evaluating_bdl/toyRegression/training_logs/model_Ensemble-MAP-SGDMOM_1_M1024_%d/checkpoints/model_Ensemble-MAP-SGDMOM_1_M1024_epoch_150.pth" % i))
